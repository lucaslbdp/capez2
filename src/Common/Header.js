    ...
    return (
        <MDBNavbar color="grey lighten-3" className="fixed-top" scrolling transparent>
            ...
            <Navbar.Brand className="ml-auto">
                ...
                >
                    <img src={process.env.PUBLIC_URL + "/instagramIcon.png"} className="mr-4"></img></a>
                <a style={{ color: "black" }}
                    target="_blank noreferrer"
                    href="https://api.whatsapp.com/send?phone=+5493815516016"
                >
                    <img src={process.env.PUBLIC_URL + "/whatsappIcon.png"} className="mr-4"></img></a>
                <a style={{ color: "black" }}
                    target="_blank noreferrer"
                    href="https://www.facebook.com/capezcomunicacion"
                >
                    <img src={process.env.PUBLIC_URL + "/facebookIcon.png"} className="mr-4"></img></a>
            </Navbar.Brand>
        </MDBNavbar>
    );
};
